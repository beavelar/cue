...
def generate_chart_series(worksheet: Worksheet, chart: ScatterChart, x_column: int, y_column: int,
	num_of_elems: int) -> None:
	'''
...
def create_excel_chart(file: str, x_title: str, y_title: str, x_column: int, y_column: int,
	graph_cell: str, num_of_elems: int) -> None:
	'''
	create_excel_chart
	----------
